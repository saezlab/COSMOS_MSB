...
##Dorothea/viper
dorothea_df <- format_dorothea_pck()
...
setwd("~/Dropbox/COSMOS_MSB/results/COSMOS_result_TF_exclusion/")
###############
...
save.image("carni_forward_prerun_TF_exclusion.RData")
...
save.image("carni_forwardrun_TF_exclusion.RData")
...
save.image("carni_doublerun_TF_exclusion.RData")
