...
psites_1 <- as.data.frame(read_csv("data/phospho_raw.csv"))
...
write_csv(ttop, "results/phospho_ttop_tumorVsHealthy.csv")
...
write.csv(Kin_activity, "results/phospho_kinase_activities.csv")
